<div class="col-lg-8 col-md-10 offset-md-1 offset-lg-0 backlight">
    ...
    <div class="product-card-big">
        ...
        <div class="justify-content-start d-flex">
            <img src="<?php echo base_url(); ?>assets/img/productimg/<?php echo $product['url'] ?>" alt="<?php echo $product['url'] ?>">
            <p class="text-justify"><span class="eng-lang"><?php echo $product['description'] ?></span><span class="ita-lang"><?php echo $product['it_description'] ?></span><span class="ser-lang"><?php echo $product['sr_description'] ?></span></p>
        </div>
        <div class="row no-gutters">
            <div class="col-sm-12 col-md-6">
                <ul>
                    <?php if (!empty($product['power'])) :; ?>
                        <b><span class="eng-lang">Power supply: </span><span class="ita-lang">Alimentazione: </span><span class="ser-lang">Napajanje: </span></b>
        ...
        <div id="show-for-admin" class="row no-guttters">
            <div class="col-4 d-flex justify-content-between">
                ...
                <?php echo form_open_multipart('products/edit'); ?>
                    <button class="btn btn-primary" type="submit"><span class="eng-lang">Edit</span><span class="ser-lang">Izmeni</span><span class="ita-lang">
                    Modificare</span></button>                            
                ...
                <div class="d-flex">
                    ...
                    <button class="btn btn-danger" type="submit"><span class="eng-lang">Delete</span><span class="ser-lang">Obriši</span><span class="ita-lang">
                            Elimina</span></button>                            
                            <input type="hidden" name="id" value="<?php echo $product['id']; ?>">
            ...
            <div class="col-8 text-center">
                <?php echo form_open_multipart('products/update_pdf'); ?>
                    <input type="hidden" name="id" value="<?php echo $product['id']; ?>">
                    <input type="hidden" name="zapdf" value="<?php echo $product['pdf']; ?>">
                    <div class="d-flex justify-content-between">
                        <input id="userfile" type="file" name="userfile" size="20">
                        <button class="btn btn-warning w-50" type="submit"><span class="eng-lang">Add pdf</span><span class="ser-lang">Dodaj pdf</span><span class="ita-lang">
                        aggiungi pdf</span></button>
                    </div>
                </form>
            </div>
        </div>
